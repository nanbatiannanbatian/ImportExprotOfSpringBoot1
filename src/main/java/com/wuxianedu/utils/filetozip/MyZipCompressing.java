...
public class MyZipCompressing {  
     ...
     * 定义压缩包的位置
     */
    public  static String zipName="file/QuestionCompressing.zip";
    public static String zipofname="QuestionCompressing.zip";
...
/*    public static void main(String[] args) {  
        ...
        try {  
            book.zip("C:\\temp\\ZipTestCompressing.zip",  
                    new File("C:\\temp"));  
        } catch (Exception e) {  
        ...
        if (file.isDirectory()) {
			try {
				...
				new File("file/sdfsd.csv").createNewFile();
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
